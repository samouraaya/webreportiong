<?php
	...
	/*Liste des Impayes*/
		...
		/*04/10/2016 fn_liste_ac_orbit*/
		private function fn_liste_ac_orbit()
		{	
			...
			$result=fn_liste_ac_orbit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		/*04/10/2016 fn_perfermance_ac_crm*/
		private function fn_perfermance_ac_crm()
		{	
			...
			$result=fn_perfermance_ac_crm();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		/*04/10/2016 fn_stock_relance_ac_agence*/
		private function fn_stock_relance_ac_agence()
		{	
			...
			$result=fn_stock_relance_ac_agence();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		/*Reporting CRM HEBDO*/
		...
		/*30.05.2017 ADD*/
		private function data_da_dashbord()
		{	
