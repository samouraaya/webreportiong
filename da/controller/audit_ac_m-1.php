...
{
	$agence=$_GET['agence'];
	$orbit = file_get_contents('http://10.80.1.51/webreporting/da/controller/api/fn_synthese_audit_orbit_m_1?agence='.$agence);
	$crm = file_get_contents('http://10.80.1.51/webreporting/da/controller/api/fn_synthese_audit_crm_m_1?agence='.$agence);
