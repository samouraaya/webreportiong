...
and datediff(month,lb.pmt_due_dt,(select last_to_dt from ov_control))=1 
...
and la.acct_no=pmt.acct_no
and his.tran_code=350
and  datediff(month,(select lh.create_dt 
from ln_history lh where lh.acct_no = la.acct_no and tran_code=345 and lh.reversal=0),(select last_to_dt from ov_control))=1
and datediff(month,lb.pmt_due_dt,(select last_to_dt from ov_control))=1
and datediff(day,lb.pmt_due_dt,(select last_to_dt from ov_control))>0
