...
function crm_orbit()
{
$orbit = file_get_contents('http://10.80.1.51/webreporting/dg/controller/api/suivi_orbit');
...
if ( $crm['RIMNO']==$orbit['rim']) 
	...
	$orbit['name']=iconv("UTF-8", "ISO-8859-1//IGNORE", $orbit['name']);
