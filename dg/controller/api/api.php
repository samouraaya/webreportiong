<?php
	...
	//////////////////////////////////////////////////////	
		...
		private function par12012month()
		{	
			...
			$result=par12012month();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function par12024month()
		{	
			...
			$result=par12024month();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function par12036month()
		{	
			...
			$result=par12036month();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function par12060month()
		{	
			...
			$result=par12060month();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function par120_tot_maturite()
		{	
		...
		/**ACM************totale_genre/* 28/09/2018*******************************/
		private function totale_genre()
		{	
		...
		/**ACM************INFO_ELV 28-01-2019******************************/
		private function INFO_ELV()
		{	
			...
			/**ACM************INFO_log /* 28/09/2018******************************/
		private function INFO_log()
		{	
		...
		/**ACM************INFO_5000 01/10/2018******************************/
		private function INFO_5000()
		{	
		...
		private function Provision_prood531_total_2017(){	
			
			if($this->get_request_method() != "GET"){
				$this->response('',406);
			}
			
			$result=Provision_prood531_total_2017();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		
		private function Provision_prood541_total_2017(){	
			
			if($this->get_request_method() != "GET"){
				$this->response('',406);
			}
			
			$result=Provision_prood541_total_2017();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		...
		private function credit_Produit()
		{	
			...
			$result=credit_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function credit_total_produit()
		{	
			...
			$result=credit_total_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		
		private function par_produit()
		{	
		...
		private function par_total_produit()
		{	
			...
			$result=par_total_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function demande_reporting_produit()
		{	
			...
			$result=demande_reporting_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function demande_reporting_total_produit()
		{	
			...
			$result=demande_reporting_total_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function cumul_week_reporting_produit()
		{	
			...
			$result=cumul_week_reporting_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function cumul_week_reporting_total_produit()
		{	
			...
			$result=cumul_week_reporting_total_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function cumul_month_reporting_produit()
		{	
			...
			$result=cumul_month_reporting_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
		private function cumul_month_reporting_total_produit()
		{	
			...
			$result=cumul_month_reporting_total_produit();
			$this->response($this->json($result), 200);
			$this->response('',204);	
		}
	}
