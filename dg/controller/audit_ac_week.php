...
function fn_synthese_audit_week()
{
	...
	$orbit = file_get_contents('http://10.80.1.51/webreporting/dg/controller/api/fn_synthese_audit_orbit_week');
	$crm = file_get_contents('http://10.80.1.51/webreporting/dg/controller/api/fn_synthese_audit_crm_week');
