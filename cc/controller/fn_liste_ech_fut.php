...
and cl.class_code <>190 and cp.user_name like '%" . $user . "%'
having (select min(bill_id_no) from ln_bill where acct_no=cr.acct_no and status='Unsatisfied ')=bl1.bill_id_no order by 'date_échéance'";
