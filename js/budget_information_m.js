	...
	var total_budget=$.ajax({
            type: "GET",
            url: "../controller/api/budget_information_branch_m",
            dataType: "json",
...
$.when(total_budget).done(function(a1) {
	$.ajax({
            type: "GET",
            url: "../controller/api/budget_information_branch_total_m",
            dataType: "json",
            success: function (data) {
				for ( var i = 0; i < data.length; i++ ) {
				var nbmonth = data[i].nbmonth;
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/top_dec_month_m",
            dataType: "json",
			beforeSend: function() {
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/top_dec_month_nb_m",
            dataType: "json",
			beforeSend: function() {
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_encours_m",
            dataType: "json",
			beforeSend: function() {
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/enc_total_budgetnb_m",
            dataType: "json",
			beforeSend: function() {
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/nb_dec_total_budget_m",
            dataType: "json",
			beforeSend: function() {
...
$.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_dec_total_budget_m",
            dataType: "json",
			beforeSend: function() {
...
var return1=$.ajax({ 
  dataType: "json",
  url: "../controller/api/vl_dec_m_object_budget_m",
  async: true,
...
var nb_dec_object_budget=$.ajax({ 
  dataType: "json",
  url: "../controller/api/nb_dec_m_object_budget_m",
  async: true,
...
var enc_total_budget_object=$.ajax({ 
  dataType: "json",
  url: "../controller/api/enc_total_budget_object_m",
  async: true,
...
var enc_total_budget_objectnb=$.ajax({ 
  dataType: "json",
  url: "../controller/api/enc_total_budget_objectnb_m",
  async: true,
...
var nb_dec_object_budget_year=$.ajax({ 
  dataType: "json",
  url: "../controller/api/nb_dec_object_budget_year_m",
  async: true,
...
var vl_dec_object_budgetyear=$.ajax({ 
  dataType: "json",
  url: "../controller/api/vl_dec_object_budgetyear_m",
  async: true,
