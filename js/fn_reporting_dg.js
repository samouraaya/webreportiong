...
/* retourne l'encours de l'agence 130*/
	...
	/* retourne l'encours de l'agence 210*/
	$.ajax({

            type: "GET",
            url: "../controller/api/Encours_210",
            dataType: "json",
			beforeSend: function() {
              $('#encours210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#encours210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de client l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_clt_act_210",
            dataType: "json",
			beforeSend: function() {
              $('#cltact210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#cltact210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de client l'agence 210*/
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/nb_dec_auj_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbdecauj210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbdecauj210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de décaissement l'agence 210*/
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_dec_auj_210",
            dataType: "json",
			beforeSend: function() {
              $('#vldecauj210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vldecauj210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de échéance prévu l'agence 130*/	
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/nb_ech_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbech210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbech210').html(names);
...
/* retourne le nombre de échéance impayé l'agence 210*/
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_ech_imp_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbechimp210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbechimp210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de PAR0 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_par0_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbpar0210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbpar0210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le VOLUME de PAR0 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_par0_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlpar0210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlpar0210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de PAR0 l'agence 210*/	
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/nb_par30_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbpar30210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbpar30210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de PAR30 l'agence 210*/		
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_par30_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlpar30210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlpar30210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de PAR7 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_par7_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbpar7210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbpar7210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de PAR7 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_par7_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlpar7210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlpar7210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de PAR90 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_par90_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbpar90210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbpar90210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de PAR90 l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_par90_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlpar90210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlpar90210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre de demande l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbdmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbdmd210').html(names);
...
/* retourne le volume de demande l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#vldmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vldmd210').html(names);
...
/* retourne le volume de demande cloturé l'agence 210*/		
	$.ajax({

            type: "GET",
            url: "../controller/api/clo_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#clodmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#clodmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande pending l'agence 210*/	
	$.ajax({

            type: "GET",
            url: "../controller/api/pen_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#pendmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#pendmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande reviewed l'agence 210*/		
	$.ajax({

            type: "GET",
            url: "../controller/api/rev_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#revdmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#revdmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande reviewed l'agence 210*/		
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/app_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#appdmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#appdmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande pending l'agence 210*/	
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_pen_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlpendmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlpendmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande reviewed l'agence 210*/	
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_rev_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlrevdmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlrevdmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume de demande reviewed l'agence 210*/		
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_app_dmd_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlappdmd210').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlappdmd210').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le cumul des demandes de cette semaine 210*/		
	$.ajax({

            type: "GET",
            url: "../controller/api/cum_dmd_week_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbdmd210week').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbdmd210week').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le nombre des crédits de cette semaine 120*/	
 ...
 /* retourne le nombre des crédits de cette semaine 210*/
	$.ajax({

            type: "GET",
            url: "../controller/api/nb_cr_week_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbcr210week').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbcr210week').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume des crédits de cette semaine 210*/		
	$.ajax({

            type: "GET",
            url: "../controller/api/vl_cr_week_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlcr210week').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlcr210week').html(names);
            },
            error: function (result) {
                alert("Error");
            }
...
/* retourne le volume des crédits de cette semaine 210*/		
	$.ajax({
            ...
            type: "GET",
            url: "../controller/api/cum_dmd_month_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbdmd210month').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbdmd210month').html(names);
            },
            error: function (result) {
                alert("Error");
            }
 ...
 $.ajax({
            ...
            type: "GET",
            url: "../controller/api/nb_cr_month_210",
            dataType: "json",
			beforeSend: function() {
              $('#nbcr210month').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#nbcr210month').html(names);
            },
            error: function (result) {
                alert("Error");
            }
 ...
 $.ajax({
            ...
            type: "GET",
            url: "../controller/api/vl_cr_month_210",
            dataType: "json",
			beforeSend: function() {
              $('#vlcr210month').html('calcul en cours...');
           },
            success: function (data) {
				var names = data[0].nb;
               $('#vlcr210month').html(names);
            },
            error: function (result) {
                alert("Error");
            }
