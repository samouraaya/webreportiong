...
/*************************/	
var utc = new Date(new Date().setMonth(new Date().getMonth()-13));    
utc=utc.toJSON().slice(0,10);
/*************total_dec_vl***************************/
var total_dec_vl = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_dec_agence_vl",
...
var total_dec_nb = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_dec_agence_nb",
...
var total_dec = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_dec_agence_vl_br",
...
var total_decnb = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_dec_agence_nb_br",
  success: function(result) {totaldecnb=result;}                     
});
...
/************************************************/ 
 var produit_dec = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_dec_produit",
...
var total_Outstanding_vl = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_Outstanding_vl",
...
var total_Outstanding_nb = $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_Outstanding_nb",
...
var Outstanding_vl_br= $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_Outstanding_vl_br",
...
var Outstanding_nb_br= $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_Outstanding_nb_br",
...
var Outstanding_CLS= $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_outsanding_produit_nbr",
...
var Outstanding_CLS_vl= $.ajax({ 
  dataType: "json",
  url: "../controller/api/total_outsanding_produit_vl",
...
var PAR0_VL_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR0_Outstanding_vl_br",
...
var PAR0_nb_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR0_Outstanding_nb_br",
...
var PAR30_VL_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR30_Outstanding_vl_br",
...
var PAR30_nb_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR30_Outstanding_nb_br",
...
var PAR90_VL_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR90_Outstanding_vl_br",
...
var PAR90_nb_Branch= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR90_Outstanding_nb_br",
...
var PAR0_per_SEX= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR0_Outstanding_per_SEX",
...
var PAR30_per_SEX= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR30_Outstanding_per_SEX",
...
var PAR90_per_SEX= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR90_Outstanding_per_SEX",
...
var PAR0_per_SIC= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR0_Outstanding_per_SIC",
...
var PAR30_per_SIC= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR30_Outstanding_per_SIC",
...
var PAR90_per_SIC= $.ajax({ 
  dataType: "json",
  url: "../controller/api/PAR90_Outstanding_per_SIC",
