...
function fn_synthese_audit_week()
{
	$nom=str_replace('%',' ',$_GET['nom']);
	$iduser=$_GET['iduser'];
	$orbit = file_get_contents('http://10.80.1.51/webreporting/ac/controller/api/fn_synthese_audit_orbit_week?iduser='.$iduser);
	$crm = file_get_contents('http://10.80.1.51/webreporting/ac/controller/api/fn_synthese_audit_crm_week?nom='.$nom);
