...
function fn_synthese_audit()
{
	...
	$orbit = file_get_contents('http://10.80.1.51/webreporting/ac/controller/api/fn_synthese_audit_orbit?iduser='.$iduser);
	$crm = file_get_contents('http://10.80.1.51/webreporting/ac/controller/api/fn_synthese_audit_crm?nom='.$nom);
